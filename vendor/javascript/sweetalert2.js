// sweetalert2@11.15.3 downloaded from https://ga.jspm.io/npm:sweetalert2@11.15.3/dist/sweetalert2.all.js
...
/**
   ...
   */const down=e=>{const t=getPopup();if(e.target===t||getIcon().contains(/** @type {HTMLElement} */e.target)){f=true;const o=getClientXY(e);b=o.clientX;v=o.clientY;y=parseInt(t.style.insetInlineStart)||0;x=parseInt(t.style.insetBlockStart)||0;addClass(t,"swal2-dragging")}};
/**
   * @param {MouseEvent | TouchEvent} event
   */const move=e=>{const t=getPopup();if(f){let{clientX:o,clientY:n}=getClientXY(e);t.style.insetInlineStart=`${y+(o-b)}px`;t.style.insetBlockStart=`${x+(n-v)}px`}};const up=()=>{const e=getPopup();f=false;removeClass(e,"swal2-dragging")};
/**
   * @param {MouseEvent | TouchEvent} event
